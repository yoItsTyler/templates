            ...
            <div className={styles.pricingPlans}>
                <div className={styles.rows}>
                    ...
                    <div className={styles.column}>
                        ...
                        <div className={styles.lBtn} onClick={() => {history.push('/plan/logo-design')}}
                        >Learn More</div>
                        </div>
                    </div>
                    ...
                    <div className={styles.column}>
                        ...
                        <div className={styles.lBtn} onClick={() => {history.push('/plan/identity-package')}}
                        >Learn More</div>
                        </div>
                    </div>
                    ...
                    <div className={styles.column}>
                        ...
                        <div className={styles.lBtn} onClick={() => {history.push('/plan/brand-strategy')}}
                        >Learn More</div>
                        </div>
                    </div>
