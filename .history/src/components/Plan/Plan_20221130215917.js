...
export const Plan = () => {
  ...
  console.log('windowDH', windowDH);
    ...
    const request = () => {
               return history.push/(`request/${id}`);
        ...
        return (
            <div className={styles.column}>
                ...
                <div className={styles.subCont}>
                    ...
                    <div className={styles.rBtn} onClick={request}>Request Free Consultation Now</div>
                ...
                <div className={styles.stickFooter}>
                    <div className={styles.footRow}>
                        ...
                        <div className={styles.rowCont}>
                            ...
                            <div className={styles.rBtn2} onClick={request}>Request Free Consultation Now</div>
                        </div>
