                    ...
                    <div className={styles.splitRow}>
                        <div className={styles.twoThirdBox}>
                            ...
                            <div className = {styles.txtRow}>
                                <div className={styles.boldTxt}>It all starts on the internet.</div>
                                <div className={styles.lightTxt}>Lune Vista Web Dev has a plan for anyone to get online.</div>
                            </div>
                        </div>
