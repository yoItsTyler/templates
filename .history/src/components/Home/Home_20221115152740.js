...
export const Home = (props) => {
    ...
    const [isMobile, setIsMmobile] = useState(props);
   ...
   /*
    ...
    useEffect(() => {
            ...
            if(props){
                if(firstRender === true){
                setIsMobile(props);
                console.log('running first useEffect, props => ', props, 'first Render ?', firstRender);
...
const ref = useRef();
   ...
   const deskTitleSize = "50px";
   const mobileTitleSize = "27px";

   const [titleSize, setTitleSize] = useState(mobileTitleSize);

   useEffect(() => {
       if(isMobile){
        console.log('props from Home is mobile => ', isMobile);
        ...
        <div className={styles.main} >
            ...
            <div className={styles.tOne} style={{ backgroundImage: 'url(' + products + ')', backgroundSize: 'cover', backgroundPosition: 'center', width: '100vw' }}>
                ...
                <div className={styles.container}>
                    <div className={styles.title} style={{fontSize: titleSize}}>Logos & Branding</div>
