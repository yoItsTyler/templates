...
export const Home = (props) => {
    ...
    const deskSubTxtSize = "22px";
    const mobileSubTxtSize = "16px";

    const deskTxtSize = [titleSize= "50px", subSize="27px"];
    const mobileTxtSize = [{titleSize: "22px"}, {subSize:"16px"}];

    
    const [propBool, setPropBool] = useState(props.props);
    ...
    const [txtSize, setTxtSize] =useState(null);
